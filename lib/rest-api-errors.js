...
export class RestApiWriteError extends HookedApiError {
  constructor (message, { cause, transactionOutcome } = {}) {
    ...
    if (cause && (typeof cause === 'object' || typeof cause === 'function')) {
      for (const field of writeErrorFields) {
        let descriptor
        for (let owner = cause; owner && !descriptor; owner = Object.getPrototypeOf(owner)) {
...
export class RestApiIncludeError extends HookedApiError {

...
export class Schema {
  ...
  _arrayType({ value, definition }) {
    // For strict array validation, reject non-array values when strictArray is true
    if (definition.strictArray !== false) {
    ...
    // Legacy behavior for backward compatibility when strictArray is explicitly false
    return Array.isArray(value) ? value : [value];
  }

  _objectType({ value, definition }) {
    // For strict object validation, reject non-object values when strictObject is true
    if (definition.strictObject !== false) {
  ...
  _booleanType({ value, definition }) {
    // For strict boolean validation, reject non-boolean values when strictBoolean is true
    if (definition.strictBoolean !== false) {
    ...
    // Legacy behavior for backward compatibility when strictBoolean is explicitly false

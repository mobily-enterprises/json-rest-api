---
title: "Custom resource methods"
chapter: 14
chapter_label: "14"
---

# 14. Custom resource methods
...
See [initial setup](01-getting-started.md) for a complete in-memory SQLite
example, and [backend capabilities](30-backend-capabilities.md) for the tested SQL
...
This example uses local resource methods without installing database
storage. Run the three blocks together in an ESM file in an application with
`json-rest-api` installed. The injected loader returns a small
...
See [Writing Plugins](29-writing-plugins.md) for registration and custom
methods, and [hooks](13-hooks-and-lifecycle.md) for the distinct
...
`tests/README.md` and [contributing](../contributing.md) to select the relevant

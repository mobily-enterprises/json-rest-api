...
the [schema enrichment migration steps](MIGRATING_API_V2.md#schema-enrichment-and-canonical-registration),
...
the transaction outcome. The [migration guide](MIGRATING_API_V2.md) explains the
...
See [the migration example](MIGRATING_API_V2.md#table-helper-schemas-use-an-explicit-structure-wrapper).
...
generated SQL and warnings for the actual database. The current verification
scope is recorded in development evidence (source checkout: `docs/development/verification-progress.md`).

...
[starting script](03-running-example.md), after installing storage and
...
a `'bulk-operations'` key. See [the migration steps](33-migrating-to-v2.md#bulk-writes).
...
Managed completion follows the [transaction contract](19-managed-transactions.md).
...
[managed transactions](19-managed-transactions.md) and
[transaction outcomes](20-transaction-outcomes.md) for file/event integration,
...
that may already have committed. See [transaction outcomes](20-transaction-outcomes.md).

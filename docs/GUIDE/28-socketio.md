...
Hook arguments use the resource runtime envelope:
...
The [real Redis tests](../contributing.md#real-databases-and-redis) exercise two Socket.IO servers
...
It does not replace the HTTP [CORS plugin](24-cors.md) or authentication.

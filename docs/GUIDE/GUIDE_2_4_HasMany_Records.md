...
Insert these blocks in order into the [starting script](GUIDE_2_1_The_Starting_Point.md)
...
[Previous: belongsTo](GUIDE_2_3_BelongsTo_Relationships.md) |
[Guide index](index.md) | [Next: polymorphic hasMany](GUIDE_2_5_HasMany_Polymorphic.md)

...
verification runtime is Node 24; see [backend capabilities](BACKEND_CAPABILITIES.md)
...
[initial setup](GUIDE_1_Initial_Setup.md). Use a fresh database and run the next

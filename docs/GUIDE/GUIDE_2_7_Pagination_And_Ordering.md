...
Use [query projections](GUIDE_X_Query_Projections.md) when a derived SQL value
...
[migration contract](MIGRATING_API_V2.md#pagination-modes-and-counts) for removed
options and count behavior.

[Previous: many-to-many](GUIDE_2_6_Many_To_Many.md) | [Guide index](index.md)

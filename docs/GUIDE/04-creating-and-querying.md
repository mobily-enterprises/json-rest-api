---
title: "Creating and querying records"
chapter: 4
chapter_label: "04"
---

# 04. Creating and querying records

This example uses countries without relationships. Insert the blocks below in
order into the [starting script](03-running-example.md), with a fresh
...
access to hidden fields. See [pagination and ordering](09-pagination-and-sorting.md)
...
older API, use the [migration guide](33-migrating-to-v2.md).

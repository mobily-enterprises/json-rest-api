...
the [starting script](03-running-example.md) before starting its server,
...
append operation. Use [relationship endpoints](11-relationship-endpoints.md)
...
have different storage behavior; see [many-to-many relationships](08-many-to-many.md).
...
[hooks](13-hooks-and-lifecycle.md) for nested response reads and
[managed transactions](19-managed-transactions.md) for atomic multi-call changes.
...
[version-field migration](22-version-field-migrations.md) for conditional writes.

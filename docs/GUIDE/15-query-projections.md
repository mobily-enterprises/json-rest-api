...
If you want to build your own plugin on the same query-field seam, see [Writing Plugins](29-writing-plugins.md).
...
[starting script](03-running-example.md) after REST/storage installation,
...
See [temporal migration requirements](33-migrating-to-v2.md#temporal-formatting-and-native-databases)
...
See [querying structured attributes](33-migrating-to-v2.md#querying-structured-attributes)
...
See [hidden sort migration](33-migrating-to-v2.md#hidden-sort-fields).
...
For display-only derived values, prefer normal computed fields from [Field Transformations](12-field-transformations.md).

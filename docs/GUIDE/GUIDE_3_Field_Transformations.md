...
[query projections](GUIDE_X_Query_Projections.md). JavaScript computations happen
...
in order into the [starting script](GUIDE_2_1_The_Starting_Point.md) before starting
...
[hook guide](GUIDE_7_Hooks_Data_Management_And_Plugins.md) for lifecycle stages.
...
must follow the [storage contract](MIGRATING_API_V2.md).
...
[transaction outcome](transaction-outcomes.md) and original error cause when

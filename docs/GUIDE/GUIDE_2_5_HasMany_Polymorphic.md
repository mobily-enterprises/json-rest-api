# 2.5 Polymorphic `hasMany` relationships
...
[starting script](GUIDE_2_1_The_Starting_Point.md), using a fresh database.
...
[Previous: hasMany](GUIDE_2_4_HasMany_Records.md) |
[Guide index](index.md) | [Next: many-to-many](GUIDE_2_6_Many_To_Many.md)

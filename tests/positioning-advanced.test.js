...
describe('Advanced Positioning Plugin Tests', { timeout: 30000 }, () => {
  ...
  describe('Custom Field Names', () => {
    it('should work with custom position field name', async () => {
      ...
      const items = await api.resources.items.query({
        queryParams: {
  ...
  describe('Integration with Other Plugins', () => {
    it('should work with soft delete scenarios', async () => {
      ...
      const activeTasks = await softDeleteApi.resources.tasks.query({
        queryParams: {
          filters: { 
    ...
    it('should handle versioning scenarios', async () => {
      ...
      // Query v1 tasks
      const v1Items = await versionApi.resources.tasks.query({
        queryParams: {
      ...
      // Query v2 tasks
      const v2Items = await versionApi.resources.tasks.query({
        queryParams: {

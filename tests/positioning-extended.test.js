...
describe('Extended Positioning Plugin Tests', { timeout: 30000 }, () => {
  ...
  describe('Edge Cases for Positioning', () => {
    ...
    it('should handle beforeId from different category', async () => {
      ...
      const cat2Tasks = await api.resources.tasks.query({
        queryParams: {
  ...
  describe('Complex Update Scenarios', () => {
    ...
    it('should handle category changes with positioning', async () => {
      ...
      const cat1Tasks = await api.resources.tasks.query({
        queryParams: {
  ...
  describe('Query and Filtering', () => {
    it('should sort correctly with mixed position values', async () => {
      ...
      const ascTasks = await api.resources.tasks.query({
        queryParams: {
          filters: { category_id: category.id },
          sort: ['position']
        }
      ...
      const descTasks = await api.resources.tasks.query({
        queryParams: {
          filters: { category_id: category.id },
          sort: ['-position']
        }
    ...
    it('should handle pagination with position sorting', async () => {
      ...
      // Query first page
      const page1 = await api.resources.tasks.query({
        queryParams: {
          filters: { category_id: category.id },
          sort: ['position'],
      ...
      // Query second page
      const page2 = await api.resources.tasks.query({
        queryParams: {
          filters: { category_id: category.id },
          sort: ['position'],
  ...
  describe('Null and Empty Filter Values', () => {
    it('should handle tasks with null category separately', async () => {
      ...
      const tasksWithCat = await api.resources.tasks.query({
        queryParams: {
          filters: { category_id: category.id },
          sort: ['position']
        }
      ...
      const tasksNoCat = await api.resources.tasks.query({
        queryParams: {
      ...
      const tasksNoFilter = await api.resources.tasks.query({
        queryParams: {
          sort: ['position']
        }
      });
  ...
  describe('Performance and Stress Tests', () => {
    it('should handle large number of tasks efficiently', async () => {
      ...
      const updatedTasks = await api.resources.tasks.query({
        queryParams: {
          filters: { category_id: category.id },
          sort: ['position'],
          page: { size: 102 }

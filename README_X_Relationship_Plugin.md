...
```javascript
import { RestApiPlugin, RestApiKnexPlugin, RestApiRelationshipsPlugin } from 'json-rest-api';
...
// Then add the relationships plugin
await api.use(RestApiRelationshipsPlugin);
